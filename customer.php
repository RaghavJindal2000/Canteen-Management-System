                              ...
                              <div class="row">
                                  <form class="col s12" method="POST" action = "">
                                    ...
                                    <div class="row">
                                      ...
                                      <a href="custsignup.php" class="waves-effejct waves-light btn btncolor center studentlogin">SIGNUP</a>
                                      <!-- <input type="submit" value="SIGNUP" class="waves-effejct waves-light btn btncolor center studentlogin"> -->
